...
if (count($todo_list)) {
    ...
    foreach ($todo_list as $todo) {
        ...
        $action = $todo['status'] ? '/todos/unchecked' : '/todos/checked';
        ...
        "<tr>
            ...
            <td>
                <div class='d-flex list-group-item'>
                    <a href='$action?id={$todo['id']}' class='w-100 text-decoration-none text-dark'>
            ...
            <td>
                <a href='/todos/delete?id={$todo['id']}' type='button' class='p-2'><i class='fa-solid fa-trash text-danger'></i></a>      
            </td> 
        </tr>";
    }
